...
TextStyle semibold14 =
    regular14.copyWith(fontWeight: FontWeight.w600, letterSpacing: 0.1);

TextStyle bold12_5 = regular12_5.copyWith(
    fontWeight: FontWeight.w700, fontSize: 16, letterSpacing: 0.1);
TextStyle bold14 =
    bold12_5.copyWith(fontWeight: FontWeight.w700, letterSpacing: -0.5);
TextStyle bold16 = bold14.copyWith(fontSize: 16, letterSpacing: 0.1);
